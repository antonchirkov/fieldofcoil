...
(function (f, n, p, e, q) {
    ...
    MathJax.Extension.MathMenu = {version: o, signal: d};
    var s = function (t) {
        return MathJax.Localization._.apply(MathJax.Localization, [["MathMenu", t]].concat([].slice.call(arguments, 1)))
    };
    var a = f.Browser.isPC, k = f.Browser.isMSIE, l = ((document.documentMode || 0) > 8);
    var i = (a ? null : "5px");
    ...
    var g = MathJax.Menu = h.Subclass({
        ...
        Background: function (u) {
            ...
            }, [["div", {style: this.BGSTYLE, menuItem: u, onmousedown: this.Remove}]]);
            var t = v.firstChild;
    ...
    var c = g.ITEM = h.Subclass({
        name: "", node: null, menu: null, Attributes: function (t) {
            return f.Insert({
                onmouseup: g.Mouseup,
                ondragstart: m,
                onselectstart: m,
            ...
            var x = document.getElementById("MathJax_MenuFrame").childNodes, u = c.GetMenuNode(y).childNodes;
    ...
    g.ENTRY = g.ITEM.Subclass({
        role: "menuitem", Attributes: function (t) {
            t = f.Insert({
    ...
    g.ITEM.SUBMENU = g.ENTRY.Subclass({
        submenu: null, marker: "\u25BA", markerRTL: "\u25C4", Attributes: function (t) {
            ...
            this.ClearTimer();
            t = {type: t.type, clientX: t.clientX, clientY: t.clientY};
    ...
    g.ITEM.LABEL = g.ENTRY.Subclass({
        role: "menuitem", Init: function (t, u) {
            if (!(t instanceof Array)) {
                t = [t, t]
            }
            this.name = t;
    ...
    g.ITEM.RULE = g.ITEM.Subclass({
        role: "separator", Attributes: function (t) {
    ...
    g.About = function (x) {
        ...
        t.push(["div", {style: {"border-top": "groove 2px", margin: ".25em 0"}}]);
    ...
    g.ShowSource = function (x) {
        ...
        var w = {screenX: x.screenX, screenY: x.screenY};
        if (!g.jax) {
            return
        }
    ...
    g.ShowSource.Text = function (y, v) {
        ...
        if (g.isMobile) {
            ...
            setTimeout(function () {
                var A = (t.outerHeight - t.innerHeight) || 30, z = (t.outerWidth - t.innerWidth) || 30, w, D;
    ...
    g.Scale = function () {
        var y = ["CommonHTML", "HTML-CSS", "SVG", "NativeMML", "PreviewHTML"], t = y.length, x = 100, v, u;
        for (v = 0; v < t; v++) {
            u = q[y[v]];
            if (u) {
                x = u.config.scale;
    ...
    g.Renderer = function () {
        ...
        if (u[0] !== r.settings.renderer) {
            var x = f.Browser, w, t = g.Renderer.Messages, v;
    ...
    g.MPEvents = function (v) {
        var u = r.settings.discoverable, t = g.MPEvents.Messages;
        if (!l) {
    ...
    g.CreateLocaleMenu = function () {
        ...
        var y = g.menu.Find("Language").submenu, v = y.items;
        var u = [], A = MathJax.Localization.strings;
        for (var z in A) {
    ...
    g.CreateAnnotationMenu = function () {
        ...
        for (var t in u) {
            if (u.hasOwnProperty(t)) {
                v.items.push(c.COMMAND([t, t], g.ShowSource, {hidden: true, nativeTouch: true, format: t}))
            }
        }
    };
...
(function (d, c, i) {
    ...
    var a = MathJax.Object.Subclass({
        ...
        UnderOver: function (n, r, l, p) {
            var q = {o: "over", u: "under"}[n.charAt(1)];
            var o = this.ParseArg(n);
            ...
            m.SetData(m[q], this.mmlToken(h.mo(h.entity("#x" + r)).With({stretchy: true, accent: !p})));
            if (l) {
        ...
        InternalMath: function (u, l) {
            ...
            if (l != null) {
                m = [h.mstyle.apply(h, m).With({displaystyle: false, scriptlevel: l})]
            } else {
                if (m.length > 1) {
                    m = [h.mrow.apply(h, m)]
                }
        ...
        oldCheckItem: e.start.prototype.checkItem, checkItem: function (j) {
            if (j.type === "stop") {
                ...
                if (i.tag) {
                    ...
                    var k = {side: g.config.TagSide, minlabelspacing: g.config.TagIndent, displaystyle: "inherit"};
